...
export const mockEvents: Event[] = [
    ...
    { 
        ...
        endTime: new Date(new Date(new Date().setDate(new Date().getDate() + 1)).setHours(12, 30, 0, 0)),
    ...
    { 
        ...
        title: 'Town Hall', 
        label: 'Event',
        startTime: new Date(new Date(new Date().setDate(new Date().getDate() + 2)).setHours(11, 0, 0, 0)),
    ...
    { 
        ...
        label: 'Shoot',
        startTime: new Date(new Date(new Date().setDate(new Date().getDate() + 2)).setHours(13, 0, 0, 0)),
        endTime: new Date(new Date(new Date().setDate(new Date().getDate() + 2)).setHours(18, 0, 0, 0)),
    ...
    { 
        ...
        title: 'Audio Mixing', 
        label: 'Sound Recording',
        startTime: new Date(new Date(new Date().setDate(new Date().getDate() + 3)).setHours(10, 0, 0, 0)),
    ...
    { 
        ...
        label: 'Rehearsal',
        startTime: new Date(new Date(new Date().setDate(new Date().getDate() + 4)).setHours(14, 0, 0, 0)),
        endTime: new Date(new Date(new Date().setDate(new Date().getDate() + 4)).setHours(18, 0, 0, 0)),
    ...
    { 
        ...
        label: 'Event',
        startTime: new Date(new Date(new Date().setDate(new Date().getDate() - 3)).setHours(9, 0, 0, 0)),
        endTime: new Date(new Date(new Date().setDate(new Date().getDate() - 3)).setHours(13, 0, 0, 0)),
    ...
    { 
        ...
        label: 'Mock Shoot',
        startTime: new Date(new Date(new Date().setDate(new Date().getDate() - 4)).setHours(14, 0, 0, 0)),
        endTime: new Date(new Date(new Date().setDate(new Date().getDate() - 4)).setHours(16, 0, 0, 0)),
    ...
    { 
        ...
        label: 'Shoot',
        startTime: new Date(new Date().setDate(new Date().getDate() + (6 - new Date().getDay() + 1))).setHours(10, 0, 0, 0), // Next Sunday
        endTime: new Date(new Date().setDate(new Date().getDate() + (6 - new Date().getDay() + 1))).setHours(16, 0, 0, 0),
