...
exports.mockTasks = [
    { taskId: 'task-1', title: 'Draft Q4 Comms Strategy', assignedTo: [exports.mockUsers[5]], dueDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 2), priority: 'task-high', status: 'in_progress', createdBy: '2', createdAt: new Date(), lastUpdated: new Date() },
    { taskId: 'task-2', title: 'Review new sizzle reel edit', assignedTo: [exports.mockUsers[0], exports.mockUsers[5]], dueDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 1), priority: 'task-high', status: 'awaiting_review', createdBy: '1', createdAt: new Date(), lastUpdated: new Date() },
    { taskId: 'task-3', title: 'Organize asset library', assignedTo: [exports.mockUsers[6]], dueDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 7), priority: 'task-medium', status: 'not_started', createdBy: '1', createdAt: new Date(), lastUpdated: new Date() },
    { taskId: 'task-4', title: 'Finalize audio mix for All-Hands', assignedTo: [exports.mockUsers[7]], dueDate: new Date(now.getFullYear(), now.getMonth(), now.getDate()), priority: 'task-high', status: 'completed', createdBy: '3', createdAt: new Date(), lastUpdated: new Date() },
    { taskId: 'task-5', title: 'Update presentation deck', assignedTo: [exports.mockUsers[9]], dueDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 3), priority: 'task-low', status: 'in_progress', createdBy: '3', createdAt: new Date(), lastUpdated: new Date() },
    { taskId: 'task-6', title: 'Source new background music', assignedTo: [exports.mockUsers[4]], dueDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 5), priority: 'task-medium', status: 'blocked', createdBy: '1', createdAt: new Date(), lastUpdated: new Date() },
];
