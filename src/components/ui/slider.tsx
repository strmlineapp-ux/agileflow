...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ref={ref}
    className={cn(
      "relative flex h-px w-full touch-none select-none items-center",
      className
    )}
    {...props}
  >
    ...
    <SliderPrimitive.Thumb className="block h-5 w-5 rounded-full border-foreground bg-card transition-colors disabled:pointer-events-none disabled:opacity-50" />
  </SliderPrimitive.Root>
))
