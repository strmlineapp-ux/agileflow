...
import { Calendar, ListChecks, Settings, LogOut, LayoutDashboard, UserCheck, Bell, Clapperboard, Megaphone, Projector } from 'lucide-react';
...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { href: '/dashboard/teams/live-events', icon: Projector, label: 'Live Events', visible: canViewLive },
