                                    ...
                                    {!isDayCollapsed && (
                                        <CardContent className="p-0 relative">
                                            ...
                                            {isWeekend || isDayHoliday ? (
                                                <div className="absolute inset-0 bg-accent/20 z-0" style={{ left: `${LOCATION_LABEL_WIDTH_PX}px` }} title="Overtime" />
                                            ) : (
                                                <>
                                                    <div className="absolute inset-y-0 bg-accent/20 z-0" style={{ left: `${LOCATION_LABEL_WIDTH_PX}px`, width: `${8 * hourWidth}px` }} title="Overtime" />
                                                    <div className="absolute inset-y-0 bg-accent/10 z-0" style={{ left: `${LOCATION_LABEL_WIDTH_PX + 8 * hourWidth}px`, width: `${1 * hourWidth}px` }} title="Extended Working Hours" />
                                                    <div className="absolute inset-y-0 bg-accent/10 z-0" style={{ left: `${LOCATION_LABEL_WIDTH_PX + 18 * hourWidth}px`, width: `${2 * hourWidth}px` }} title="Extended Working Hours" />
                                                    <div className="absolute inset-y-0 bg-accent/20 z-0" style={{ left: `${LOCATION_LABEL_WIDTH_PX + 20 * hourWidth}px`, width: `${4 * hourWidth}px` }} title="Overtime" />
                                                </>
                                            )}
