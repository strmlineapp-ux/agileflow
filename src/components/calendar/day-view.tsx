                ...
                <div style={{ width: `${LOCATION_LABEL_WIDTH_PX + (24 * hourWidth)}px`}}>
                    ...
                    <CardContent className="p-0 relative">
                        ...
                        {isWeekend || isDayHoliday ? (
                            <div className="absolute inset-0 bg-slate-200/75 dark:bg-slate-800 z-0" style={{ left: `${LOCATION_LABEL_WIDTH_PX}px` }} title="Overtime" />
                        ) : (
                            <>
                                <div className="absolute inset-y-0 bg-slate-200/75 dark:bg-slate-800 z-0" style={{ left: `${LOCATION_LABEL_WIDTH_PX}px`, width: `${8 * hourWidth}px` }} title="Overtime" />
                                ...
                                <div className="absolute inset-y-0 bg-slate-200/75 dark:bg-slate-800 z-0" style={{ left: `${LOCATION_LABEL_WIDTH_PX + 20 * hourWidth}px`, width: `${4 * hourWidth}px` }} title="Overtime" />
                            </>
                        )}
                ...
                <CardContent className="p-0 relative">
                    <div className="grid grid-cols-[auto,1fr] min-h-full">
                        ...
                        <div className="relative">
                             {/* Working Hours Backgrounds */}
                            {isWeekend || isDayHoliday ? (
                                <div className="absolute inset-0 bg-slate-200/75 dark:bg-slate-800 z-0" title="Overtime" />
                            ) : (
                                <>
                                    <div className="absolute inset-x-0 top-0 bg-slate-200/75 dark:bg-slate-800 z-0" style={{ height: `${8 * hourHeight}px` }} title="Overtime" />
                                    ...
                                    <div className="absolute inset-x-0 bottom-0 bg-slate-200/75 dark:bg-slate-800 z-0" style={{ height: `${4 * hourHeight}px` }} title="Overtime" />
                                </>
                            )}
                            {/* Grid lines */}
                            {hours.map(hour => (
