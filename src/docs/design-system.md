...
- **Icon Sizing**: The trigger button's icon should be large and prominent, specifically using `text-6xl` (`font-size: 60px`) with `weight={100}` inside a `h-12 w-12` button.
- **Interaction:**
